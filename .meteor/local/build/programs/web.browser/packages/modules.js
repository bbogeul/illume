...
install("fourseven:scss");                                                   // 67
install("materialize:materialize");                                          // 68
install("deps");                                                             // 69
install("aldeed:simple-schema");                                             // 70
install("livedata");                                                         // 71
install("htmljs");                                                           // 72
install("observe-sequence");                                                 // 73
install("reactive-var");                                                     // 74
install("blaze");                                                            // 75
install("spacebars");                                                        // 76
install("templating");                                                       // 77
install("ui");                                                               // 78
install("momentjs:moment");                                                  // 79
...
install("aldeed:autoform");                                                  // 85
install("dfischer:phantomjs");                                               // 86
install("ongoworks:spiderable");                                             // 87
install("iron:core");                                                        // 88
install("iron:dynamic-template");                                            // 89
install("iron:layout");                                                      // 90
install("iron:url");                                                         // 91
install("iron:middleware-stack");                                            // 92
install("iron:location");                                                    // 93
install("iron:controller");                                                  // 94
install("iron:router");                                                      // 95
install("okgrow:router-autoscroll");                                         // 96
install("coffeescript");                                                     // 97
install("timmyg:wow");                                                       // 98
...
install("shell-server");                                                     // 116
install("alanning:roles");                                                   // 117
install("meteorspark:util");                                                 // 118
