...
install("callback-hook");                                                    // 100
install("accounts-base", "meteor/accounts-base/client_main.js");             // 101
install("sha");                                                              // 102
install("srp");                                                              // 103
install("accounts-password");                                                // 104
install("fortawesome:fontawesome");                                          // 105
install("ostrio:iron-router-helper-class");                                  // 106
install("ostrio:iron-router-title");                                         // 107
install("ostrio:iron-router-meta");                                          // 108
install("standard-minifier-css");                                            // 109
install("standard-minifier-js");                                             // 110
install("datariot:ganalytics");                                              // 111
install("matb33:collection-hooks");                                          // 112
