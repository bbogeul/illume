...
install("materialize:materialize");                                          // 67
install("deps");                                                             // 68
install("aldeed:simple-schema");                                             // 69
install("livedata");                                                         // 70
install("htmljs");                                                           // 71
install("observe-sequence");                                                 // 72
install("reactive-var");                                                     // 73
install("blaze");                                                            // 74
install("spacebars");                                                        // 75
install("templating");                                                       // 76
install("ui");                                                               // 77
install("momentjs:moment");                                                  // 78
install("raix:eventemitter");                                                // 79
install("aldeed:collection2-core");                                          // 80
install("aldeed:schema-index");                                              // 81
install("aldeed:schema-deny");                                               // 82
install("aldeed:collection2");                                               // 83
install("aldeed:autoform");                                                  // 84
install("dfischer:phantomjs");                                               // 85
install("ongoworks:spiderable");                                             // 86
...
install("iron:controller");                                                  // 93
install("iron:router");                                                      // 94
install("okgrow:router-autoscroll");                                         // 95
install("coffeescript");                                                     // 96
install("timmyg:wow");                                                       // 97
install("npm-bcrypt");                                                       // 98
install("ddp-rate-limiter");                                                 // 99
install("localstorage");                                                     // 100
install("callback-hook");                                                    // 101
...
install("ostrio:iron-router-helper-class");                                  // 107
install("ostrio:iron-router-title");                                         // 108
install("ostrio:iron-router-meta");                                          // 109
install("standard-minifier-css");                                            // 110
install("standard-minifier-js");                                             // 111
install("datariot:ganalytics");                                              // 112
install("matb33:collection-hooks");                                          // 113
install("gildaspk:autoform-materialize");                                    // 114
install("gadicohen:sitemaps");                                               // 115
install("webapp");                                                           // 116
install("hot-code-push");                                                    // 117
install("fastclick");                                                        // 118
